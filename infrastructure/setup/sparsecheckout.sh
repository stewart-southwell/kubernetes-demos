...
# This script takes a list of directories to clone from the kubernetes-demos repo. Since it's a subset of 
...
DIR="aks-demo"
REPOS="https://github.com/$gitUser/kubernetes-demos"
BRANCH=$gitBranch
...
if [ -d "$DIR" ]; then
    ...
    # Current structure is ~/kubernetes-demos/modules/helm-deploy-aks/src (for example).
